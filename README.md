...
All this api have hypermedia pagination and they return content as show in the example. The page parameter for all the apis is optional. The size of all the pages in 10 
